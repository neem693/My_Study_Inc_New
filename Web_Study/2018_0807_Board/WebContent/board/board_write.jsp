...
<tr>
<td>
<form name="f" method="post" action="board_write_ok.jsp"> 
<table width="750" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<input name="writter" type="text" class="search" style="width:250px;">
		</td>
	</tr>
...
<table width="750" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td align="center"><img src="../img/btn_reg.gif" onClick="return send_check(2)" style="cursor:hand">
		<img src="../img/btn_back.gif" onClick="JavaScript:location.href='board_list.jsp'" style="cursor:hand"></td>
	</tr>
</table>

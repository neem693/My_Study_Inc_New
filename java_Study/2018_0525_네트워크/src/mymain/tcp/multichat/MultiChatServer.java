...
//		jlist_user.setListData(user_array);
	...
	public void my_send_userlist() {
		...
		sb.append("\n"); //붙이는 이유 ??? : BufferedReader로 수신
		
		String send_userlist = sb.toString();
		//String send_userlist = "리스트#길동1#길동2#길동3#"
		
		my_send_message_all(send_userlist);
	...
	void my_send_message_all(String message) {
		// TODO Auto-generated method stub

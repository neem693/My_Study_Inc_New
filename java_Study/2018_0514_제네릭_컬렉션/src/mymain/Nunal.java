	...
	private void init_gamepan() {
		...
		gamePan = new JPanel() {
			...
			protected void paintComponent(Graphics g) {
				...
				//·ºÅÊ±Û
				g.drawRect(eye_left.x - eye_radius +5, eye_left.y - eye_radius + 5, eye_radius * 2 - 15, eye_radius * 2 -15);
				g.drawRect(eye_right.x - eye_radius +5, eye_right.y - eye_radius + 5, eye_radius * 2 - 15, eye_radius * 2 -15);
